...
{
  public class SharepointUsersRepository
    {

    private ClientContext clientContext;
    private SharepointPeopleManagerAppService peopleManagerHelper;
    private UsuarioRepository usuarioRepo;

    public SharepointUsersRepository(ClientContext clientContext)
        {

          this.clientContext = clientContext;
          peopleManagerHelper = new SharepointPeopleManagerAppService(this.clientContext);
      ...
      foreach (var user in siteUsers)
      {
        ...
        if (peopleManagerHelper.ExecuteRequest())
        {
